...
public class AutoDumpAndPickup extends SequentialCommandGroup {
  ...
  public AutoDumpAndPickup() {
    ...
    TrajectoryMaker forwardPath = DaphneOneContainer.getContainer().createForwardPath3();
    TrajectoryMaker forwardScorePath = DaphneOneContainer.getContainer().createForwardPath2();
    TrajectoryMaker backPath = DaphneOneContainer.getContainer().createBackwardPath();
    TrajectoryMaker forwardPath2 = DaphneOneContainer.getContainer().createForwardPath4();
    addCommands(
